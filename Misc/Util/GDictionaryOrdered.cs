...
public class GDictionaryOrdered<K, V> : IDictionary<K, V>
{
    WTFDictionary<int, IDObjectDictG> InternalDict = new WTFDictionary<int, IDObjectDictG>();
